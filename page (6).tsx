  ...
  return (
    <div className="min-h-[80vh] px-6 py-8 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          { icon: <Users className="w-5 h-5" />, title: "Total Users", value: "1,247", color: "text-nv-pink" },
          { icon: <ShoppingCart className="w-5 h-5" />, title: "Orders Today", value: "43", color: "text-nv-purple" },
          { icon: <Ticket className="w-5 h-5" />, title: "Open Tickets", value: "7", color: "text-nv-warning" },
          { icon: <Activity className="w-5 h-5" />, title: "Active Licenses", value: "892", color: "text-nv-success" },
        ].map((card) => (
